...
public enum ModItemTier implements IItemTier {
    ABOBA(2, 350, 6.5F, 2.3F, 12, () -> {
        return Ingredient.of(ModItems.HASH_MAP.get("aboba").get());
    }),
    NE_ABOBA(3, 1061, 8.0F, 3.0F, 18, () -> {
        return Ingredient.of(ModItems.HASH_MAP.get("ne_aboba").get());
    });
